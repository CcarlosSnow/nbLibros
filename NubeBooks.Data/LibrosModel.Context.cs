...
namespace NubeBooks.Data
{
    ...
    public partial class LibrosDBEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> USP_ActualizarSaldosMovimientos(Nullable<int> idCuentaBancaria, Nullable<System.DateTime> fechaAnterior, Nullable<System.DateTime> fechaNueva, Nullable<decimal> montoAnterior, Nullable<decimal> montoNuevo, Nullable<int> idAccion, Nullable<int> idMovimiento)
        {
            var idCuentaBancariaParameter = idCuentaBancaria.HasValue ?
                new ObjectParameter("IdCuentaBancaria", idCuentaBancaria) :
                new ObjectParameter("IdCuentaBancaria", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("USP_ActualizarSaldosMovimientos", idCuentaBancariaParameter, fechaAnteriorParameter, fechaNuevaParameter, montoAnteriorParameter, montoNuevoParameter, idAccionParameter, idMovimientoParameter);
        }
    }
}
